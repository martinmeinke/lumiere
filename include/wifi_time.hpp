...
{
public:
    WiFiEventHandler(WifiTime &wifi_time, bool connect_to_preconfigured_station) : m_wifi_time(wifi_time), m_connect_to_preconfigured_station(connect_to_preconfigured_station)
    {
...
public:
    ...
    {
        handler = std::make_unique<WiFiEventHandler>(*this, connect_to_preconfigured_station);
    }
